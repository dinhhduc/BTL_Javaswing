...
public class FormKhoa extends JPanel {
    private JTextField txtSearch = new JTextField();
    private JButton btnSearch = new JButton("Tìm");

    private JTextField txtMaKhoa = new JTextField();
    private JTextField txtTenKhoa = new JTextField();
    ...
    private JComponent createFormCard() {
        ...
        JLabel lb = new JLabel("Thông tin khoa");
        ...
        int r = 0;
        r = addRow(form, gbc, r, "Mã khoa", txtMaKhoa);
        r = addRow(form, gbc, r, "Tên khoa", txtTenKhoa);
        ...
        styleInput(txtMaKhoa);
        txtMaKhoa.setEditable(false);
        txtMaKhoa.setBackground(new Color(230, 230, 230));

        styleInput(txtTenKhoa);
    ...
    private JComponent createTableCard() {
        ...
        JLabel lb = new JLabel("Danh sách khoa");
        lb.setFont(new Font("Segoe UI", Font.BOLD, 16));
        lb.setForeground(new Color(30, 50, 90));
        ...
        tblKhoa.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        tblKhoa.getTableHeader().setFont(new Font("Segoe UI", Font.BOLD, 13));
        tblKhoa.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);

        JScrollPane sp = new JScrollPane(tblKhoa);
    ...
    public JTable getTblKhoa() { return tblKhoa; }
    public DefaultTableModel getModel() { return model; }

    public String getMaKhoa() { return txtMaKhoa.getText().trim(); }
    public String getTenKhoa() { return txtTenKhoa.getText().trim(); }

    public void setMaKhoa(String ma) { txtMaKhoa.setText(ma); }
